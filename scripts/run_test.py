...
import json
with open("/data/duxuan/aw_nas_private/results/latency.json", "r") as fr:
    lat = json.load(fr)


for i, idx in enumerate(lat):
    queue.put((i, idx))    
